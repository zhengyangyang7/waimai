...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://localhost:3306/elm?useUnicode=true&characterEncoding=utf-8&useSSL=false&allowMultiQueries=true";   //注意修改数据库名
        String name="root";
        String password="";
        ...
        //基本信息
        String author = "veliona";    //作者
        String parent = "com";   //父包名
        String module = "veliona.elemebackend";   //模块包名
